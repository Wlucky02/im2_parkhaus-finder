...
export async function getParkhouses() {
  ...
  if (results !== null && results.results) {
    ...
    console.error("API Results sind null oder fehlerhaft");
  }
...
// ==========================================
// AUTOMATISCHER START BEIM SEITENSTART
// ==========================================
if (window.alreadyStarted === undefined) {
  window.alreadyStarted = false;
}

document.addEventListener("DOMContentLoaded", async () => {
  if (window.alreadyStarted) return;
  ...
  // Führt den Code NUR aus, wenn wir auf der Hauptseite sind (Kacheln oder Top 5 vorhanden)
